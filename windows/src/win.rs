...
//! control of the background process. Together with daemon.rs, this is where all of the Windows
//! app's `unsafe` lives.
...
use ipassword_shared::config::{Hotkey, MOD_ALT, MOD_CONTROL, MOD_SHIFT, MOD_WIN};
use ipassword_shared::paths;
use ipassword_shared::platform::TypeJob;
